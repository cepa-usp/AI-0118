...
function startAI(){
    loadScreen("../swf/AI-0117.swf", 640, 480);
    loadContent();
...
function start_quadro2(){
    $("#btAbrirQuadro21").button().click(function (){
        loadSlide('quadro21');
    });
}

function start_quadro21(){
...
function start_quadro4(){
    $("#btAbrirQuadro5").button().click(function (){
        loadSlide('quadro5');
    });
}
...
function start_quadro8(){
    $("#btAbrirQuadro9").button().click(function (){
        loadSlide('quadro9');
    });
}


function start_quadro9(){
    $("#btAbrirQuadro10").button().click(function (){
        loadSlide('quadro10');
    });
}

function start_quadro10(){
    $("#btAbrirQuadro11").button().click(function (){
        loadSlide('quadro11');
    });
}

function start_quadro11(){
    $("#btAbrirQuadro12").button().click(function (){
        loadSlide('quadro12');
    });
}

function start_quadro12(){
