...
function start_quadro2() {
        ...
        if(oaData[6].slides.a_sort==-9999){
            ...
            oaData[6].slides.a_sort = a_sort;
            oaData[6].slides.c_sort = c_sort;
        } else {
...
function avaliarQuadro3(){
    ...
    if(r_c==-1) oaData[6].slides.score3+=34;
...
function posFetchConfig () {
	//Parada 1
	if(oaData[6].slides.resp_06_01_verify == "")
	{
